...
bool syntax_errors = false; // global flag set on syntax errors
...
void initErrorProcessing() {
    ...
    niceTokenNameMap["NUMBERCONST"] = (char *)"numeric constant";
...
void yyerror(const char *msg)
{
    ...
    syntax_errors = true; // set global flag
