...
* File compiled:  ../testDataA7/UnitTests/k03.c-
* 
* ** ** ** ** ** ** ** ** ** ** ** **
* FUNCTION input
...
* FOR
 ...
 53:     ST  3,-3(1)	save starting value in index variable 
 54:    LDC  3,3(6)	Load integer constant 
 55:     ST  3,-4(1)	save stop value 
 56:    LDC  3,1(6)	default increment by 1 
 57:     ST  3,-5(1)	save step value 
 58:     LD  4,-3(1)	loop index 
 59:     LD  5,-4(1)	stop value 
 60:     LD  3,-5(1)	step value 
 61:    SLT  3,4,5	Op < 
...
* EXPRESSION
* CALL output
 71:     ST  1,-6(1)	Store fp in ghost frame for output
* TOFF dec: -7
* TOFF dec: -8
* Param 1
 72:     LD  3,-3(1)	Load variable j
 73:     ST  3,-8(1)	Push parameter 
* TOFF dec: -9
* Param end output
 74:    LDA  1,-6(1)	Ghost frame becomes new active frame 
...
* EXPRESSION
* CALL outnl
 78:     ST  1,-6(1)	Store fp in ghost frame for outnl
* TOFF dec: -7
* TOFF dec: -8
* Param end outnl
...
* Bottom of loop increment and jump
 83:     LD  3,-3(1)	Load index 
 84:     LD  5,-5(1)	Load step 
 85:    ADD  3,3,5	increment 
 86:     ST  3,-3(1)	store back to index 
